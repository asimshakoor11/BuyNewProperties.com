...
const SingleUnitPopup = ({ isOpen, onClose, images }) => {
    ...
    return (
        <>
            <div id="popup-container" class="fixed inset-0 z-50 h-screen bg-gray-800 p-4 pb-20 md:pb-4 bg-opacity-50 backdrop-blur-lg flex justify-center items-center transition-opacity duration-300 "
            >

...
const VideoPopup = ({ videoUrl, onClose }) => {
    return (
        ...
        <div className='fixed inset-0 z-50 bg-gray-800 p-4 md:p-0  bg-opacity-50 backdrop-blur-lg flex justify-center items-center transition-opacity duration-300'>

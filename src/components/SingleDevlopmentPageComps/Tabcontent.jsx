    ...
    return (
        ...
        {cards.map((card, index) => (
            <div key={index} className="w-[250px] min-h-[220px] flex flex-col items-center justify-center border-2 rounded-lg">
                <img src={`./src/assets/images/icons/${card.icon}.svg`} alt={`${card.title} Icon`} className="mx-auto mb-2" />
                ...
                <div className="flex justify-center items-center mt-2">
                    ...
                    <img src="./src/assets/images/icons/disclaimer.svg" alt="Disclaimer Icon" />
                </div>
            </div>
        ))}
    </div>

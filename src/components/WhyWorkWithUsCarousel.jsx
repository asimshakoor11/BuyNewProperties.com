...
const WhyWorkWithUsCarousel = () => {
    ...
    const items = [
        {
            imgSrc: "/images/homepage/legalfees.png",
        ...
        {
            imgSrc: "/images/homepage/clientareaN.png",
        ...
        {
            imgSrc: "/images/homepage/easyprocessSF.png",
    ...
    return (
        <>
            <div ref={carouselRef} className="w-full flex flex-nowrap justify-evenly py-2 overflow-x-scroll gap-6 scrollbar-hide mt-10 pr-[7%]">
                {items.map((item, index) => (
                    <div className='trnasformscale'>
                        <div
                            key={index}
                            ref={divRef}
                            data-aos="fade-up"
                       ...
                       min-w-[320px] max-w-[320px] md:min-w-[350px] md:max-w-[350px] h-full"
                        >
                            <div className='flex flex-col justify-between gap-4 p-6 h-full'>
                                <div className='flex flex-col gap-4'>
                                    ...
                                    <h3 className="text-xl font-bold text-primarycolor pr-6">{item.title}</h3>
            ...
            <AnimatePresence>
                {isPopupVisible && (
                    <motion.div
                        className="fixed inset-0 z-50 bg-gray-800 p-4 md:p-0  bg-opacity-50 backdrop-blur-lg flex justify-center items-center transition-opacity duration-300"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
